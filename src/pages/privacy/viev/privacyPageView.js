        ...
        return (
          <>
            ...
            <div className="home-bottom">
              ...
              <p>Can Evim Yardımlaşma Ağı (Bundan b&ouml;yle &ldquo;Can Evim olarak
                anılacaktır.),&nbsp;<a href="http://www.canevim.org">www.canevim.org</a>&nbsp;(Bundan
                ...
                yardımlaşma faaliyetlerinin y&uuml;r&uuml;t&uuml;lmesini hedeflemektedir. Bu doğrultuda Can Evim
                , İnternet Sitesi&rsquo;nde &uuml;yeleri tarafından verilen bilgilerin nasıl kullanıldığı ve
                ...
                <br /> Can Evim, İnternet Sitesi&rsquo;nde y&uuml;r&uuml;t&uuml;len faaliyeti
                ...
                <br /> &Uuml;yeler tarafından İnternet Sitesi&rsquo;nde Can Evim ile paylaşılmış olan kişisel
                ...
                genel kullanıma a&ccedil;ık olmayan g&uuml;venli bir ortamda saklanmakta ve sadece Can Evim
                ...
                sağlanabilmesi a&ccedil;ısından Can Evim sistem ve internet altyapısını en g&uuml;venilir
                ...
                i&ccedil;erisindedir.Can Evim ve İnternet Sitesi kullanıcılarının gizlilik haklarına saygı
                duyar ve kullanıcının site vasıtasıyla sağladığı t&uuml;m bilgileri saklı tutar.Bununla birlikte Can
                Evim ve dolayısıyla İnternetSitesi &uuml;&ccedil;&uuml;nc&uuml; şahısların yasal ya da yasal
                olmayan davranışlarının herhangi bir kişi veya kuruma verebileceği hasarlardan sorumlu tutulamaz.<br />
                <br /> Can Evim, s&ouml;z konusu bilgileri &uuml;yelerin onayı yada aksi bir talimatı
                olmaksızın ya da yasal bir y&uuml;k&uuml;ml&uuml;l&uuml;k altında bulunmadığı s&uuml;rece herhangi
                bir &uuml;&ccedil;&uuml;nc&uuml; şahıs, kurum ve kuruluş ile paylaşmayacaktır.<br /> <br /> Can Evim
                , bu bilgileri sadece gerekli yetkiler ve yasal d&uuml;zenlemeler &ccedil;er&ccedil;evesinde
                a&ccedil;ıklayabilecek olup, Can Evim&rsquo;nun tabi olduğu d&uuml;zenleyici mevzuat, yetkili
                kurumlar ve/veya yasama, y&uuml;r&uuml;tme, yargı organ ve mercileri &uuml;ye bilgilerinin
                a&ccedil;ıklanmasını istediğinde, Can Evim bu bilgileri yalnızca gerekli
                ...
                kullanılmayacak ve satılmayacaktır.<br /> <br /> Can Evim, idari ve operasyonel a&ccedil;ıdan
                ...
                <br /> İnternet Sitesi&rsquo;nin i&ccedil;eriği Can Evim tarafından hazırlanmaktadır.<br />
                <br /> Can Evim, İnternet Sitesi&rsquo;nin geliştirilmesi ve desteklenmesi maksadıyla destek
                hizmetler almak amacıyla farklı kuruluşlarla &ccedil;alışılması durumunda, bu firmaların Can Evim
                gizlilik standartlarına ve şartlarına uymalarını sağlayacaktır.<br /> <br /> İnternet
                ...
                ve kayıplardan Can Evim sorumlu değildir.<br /> <br /> İnternet Sitesi&rsquo;nde ve İnternet
                Sitesi&rsquo;nde yer alan bilgi, materyal ve bunların d&uuml;zenlenmesi konusundaki telif hakları, Can
                Evim'e aittir. İnternet Sitesi&rsquo;nin
                ...
                m&uuml;lkiyet hakları Can Evim&rsquo;nda saklıdır.<br /> <br /> &Uuml;yelerin Can Evim
                ile paylaştığı bilgiler,sosyal yardımlaşma faaliyetinin y&uuml;r&uuml;t&uuml;lmesinde ve İnternet
                Sitesi&rsquo;nde yer alan uygulamaların yenilenmesi durumunda bilgilendirme yapmak amacıyla
                kullanılabilecektir.<br /> <br /> &Uuml;yelerin kişisel bilgilerinin gizliliğini korumak amacıyla Can
                Evim tarafından sistem ve internet altyapısı en g&uuml;venilir seviyede tutularak
                gerekli &ouml;nlemler alınmıştır. Ek olarak bilgi alınmak istenen konularda İnternet Sitemiz&rsquo;den
                bize ulaşabilirsiniz.<br /> <br /> Can Evim&rsquo;nun g&ouml;nderim listesinden &ccedil;ıkmak
